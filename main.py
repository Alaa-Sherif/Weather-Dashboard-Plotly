...
def update_graphs(value, city):
  ...
  #     label="Wind",
  #     value=current_wind,
  #     color={"gradient":True,"ranges":{"green":[0,5],"yellow":
  #     [5,9],"red":[9,10]}},
  #     max = 100,
  #     min = 0,
  # )
  ...
  #     "lon": 31.25,
  #     "tz_id": "Africa/Cairo",
  #     "localtime_epoch": 1680092309,
  #     "localtime": "2023-03-29 14:18"
  #   },
  #   "current": {
  #     "last_updated_epoch": 1680092100,
  #     "last_updated": "2023-03-29 14:15",
  #     "temp_c": 22,
  #     "temp_f": 71.6,
  #     "is_day": 1,
  #     "condition": {
